...
public class UltrasonicLocalizer implements Runnable {
  ...
  public static void ultrasonicLocalising() {
    Navigation.turnBy(-90);                      // turn 90 degrees counter-clockwise
    ...
    Navigation.turnBy(-90);    //turn additional 90 degrees counter-clockwise
    ...
    Navigation.turnBy(180); //turn the robot 180 degrees so it orients to 0 degree
  ...
  public static void fallingEdge() {
    ...
    Navigation.turnBy(360-updatedHeading); // the robot orients to 0 degree angle
